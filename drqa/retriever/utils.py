...
def save_bm25(filename, data, metadata=None):
    data = {
        'data': data,
        'metadata': metadata
    }
...
def load_bm25(filename):
    ...
    return loader['data'].item(), loader['metadata'].item()
    #return loader['data'].item()['idf'], loader['data'].item()['doc_freqs'], loader['data'].item()['doc_len'],loader['data'].item()['avgdl'], loader['metadata'].item()
#def save_bm25(filename, bm25, metadata=None):
