...
#    ranker = retriever.get_class('tfidf')(tfidf_path=args.model)
    ...
    closest_docs = ranker.batch_closest_docs(
       questions, k=args.n_docs,  num_workers=args.num_workers, k1=0.93, b=0.1)#seva,k1=1.96,b=0.24)#,	k1=1.87,b=0.084)#k1=1.87,b=0.084)
    #closest_docs = ranker.batch_closest_docs(
...
#    np.save("correct_lens_wiki_idx.npy", correct_wiki_lens)
   ...
   #
    savefn="rretrieved_lens_searchQA_lucene_bigram_tuned.npy"
    np.save(savefn,lens)
